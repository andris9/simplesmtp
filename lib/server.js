 ...
 *     <li><b>optionalSTARTTLS</b> - if set, allow client do not use STARTTLS</li>
 * </ul>
 * 
 * @constructor
...
function SMTPServer(options){
    ...
    this.options.optionalSTARTTLS = !!this.options.optionalSTARTTLS;
...
SMTPServerConnection.prototype._onCommandAUTH = function(payload){
    ...
    if(!this.server.options.optionalSTARTTLS && !this.client.secureConnection){
...
SMTPServerConnection.prototype._onCommandEHLO = function(host){
    ...
    if((this.client.secureConnection || this.server.options.optionalSTARTTLS) && (this.server.options.requireAuthentication || this.server.options.enableAuthentication)){

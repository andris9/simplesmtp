 ...
 *     <li><b>credentials</b> - TLS credentials
 *     <li><b>authMethods</b> - allowed authentication methods, defaults to <code>["PLAIN", "LOGIN"]</code>
 * </ul>
 * 
 * @constructor
...
SMTPConnection.prototype.init = function(keepAuthData){
    ...
    if(this.hostnamehostNameAppearsAs){
